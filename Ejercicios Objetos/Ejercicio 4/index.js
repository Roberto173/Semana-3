...
parrafos = `<p>${randomObject.them.speed.past.program.grade.addition.whose.national.cannot.board}<p>`;
document.getElementById("div1").innerHTML = parrafos;

randomObject.them.speed.past.program.grade.addition.whose.national.cannot.board.name = "datoEntrada";

parrafos = `<p>${randomObject.them.speed.past.program.grade.addition.whose.national.cannot.board.name}<p>`;
