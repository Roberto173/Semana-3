...
let nombreEntrada = window.prompt(`Introduzca su nombre:`);
let titulo = "";
...
if (nombreEntrada = personas.nombre) {

    titulo = `<h1>${nombreEntrada}<h1>`;
    document.getElementById("div1").innerHTML = titulo;

}
else {

    titulo = `<h1>Lo sentimos. Su nombre no aparece en la lista</h1>`;
    document.getElementById("div1").innerHTML = titulo;
